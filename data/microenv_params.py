...
class MicroenvTab(object):
    ...
    def __init__(self):
        ...
        menv_var2 = Button(description='NP1', disabled=True, layout=name_button_layout)
        ...
        self.NP1_diffusion_coefficient = FloatText(value=6,
        ...
        self.NP1_decay_rate = FloatText(value=1.6667e-05,
        ...
        self.NP1_initial_condition = FloatText(value=0,style=style, layout=widget_layout)
        param_name8 = Button(description='Dirichlet_boundary_condition', disabled=True, layout=name_button_layout)

        self.NP1_Dirichlet_boundary_condition = FloatText(value=2,style=style, layout=widget_layout)
        self.NP1_Dirichlet_boundary_condition_toggle = Checkbox(description='on/off', disabled=False,style=style, layout=widget_layout)
        ...
        menv_units_button8 = Button(description='1/micron^3', disabled=True, layout=units_button_layout) 
        ...
        row_NP1 = [menv_var2,  ] 
        row5 = [param_name5, self.NP1_diffusion_coefficient, menv_units_button5]
        row6 = [param_name6, self.NP1_decay_rate, menv_units_button6]
        row7 = [param_name7, self.NP1_initial_condition, units_button1]
        row8 = [param_name8, self.NP1_Dirichlet_boundary_condition, menv_units_button8, self.NP1_Dirichlet_boundary_condition_toggle]
    ...
    def fill_gui(self, xml_root):
        ...
        self.NP1_diffusion_coefficient.value = float(vp[1].find('.//diffusion_coefficient').text)
        self.NP1_decay_rate.value = float(vp[1].find('.//decay_rate').text)
        self.NP1_initial_condition.value = float(vp[1].find('.//initial_condition').text)
        self.NP1_Dirichlet_boundary_condition.value = float(vp[1].find('.//Dirichlet_boundary_condition').text)
        if vp[1].find('.//Dirichlet_boundary_condition').attrib['enabled'].lower() == 'true':
          self.NP1_Dirichlet_boundary_condition_toggle.value = True
        else:
          self.NP1_Dirichlet_boundary_condition_toggle.value = False
    ...
    def fill_xml(self, xml_root):
        ...
        vp[1].find('.//diffusion_coefficient').text = str(self.NP1_diffusion_coefficient.value)
        vp[1].find('.//decay_rate').text = str(self.NP1_decay_rate.value)
        vp[1].find('.//initial_condition').text = str(self.NP1_initial_condition.value)
        vp[1].find('.//Dirichlet_boundary_condition').text = str(self.NP1_Dirichlet_boundary_condition.value)
        vp[1].find('.//Dirichlet_boundary_condition').attrib['enabled'] = str(self.NP1_Dirichlet_boundary_condition_toggle.value).lower()
